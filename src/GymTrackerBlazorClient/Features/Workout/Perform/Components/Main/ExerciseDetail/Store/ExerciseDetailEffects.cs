...
public class ExerciseDetailEffects : EffectsBase
{
    private readonly IClientStorage _clientStorage;
    private readonly NavigationManager _navigationManager;

    public ExerciseDetailEffects(IClientStorage clientStorage, NavigationManager navigationManager, ErrorService errorService)
        : base(errorService)
    {
